...
typedef enum {
    ...
    // Host commands
    HOST_COMMAND, HOST_WRITE, HOST_WRITE_FM, HOST_READ_POS,
    HOST_READ, HOST_REWIND, HOST_SPACE,
    HOST_LOAD, HOST_UNLOAD, HOST_LOCATE,

    // Internal requests
    STREAM_BUFFER_REQUEST, STREAM_SEGMENT_REQUEST, MAP_UPDATE, EXTEND_READ_STREAM,

    // Internal commands
    FLUSH_WRITE_CACHE, DISCARD_READ_CACHE, ERASE_CARTRIDGE,

    // Data carriers
    SUPERBLOCK, PAD_SUPERBLOCK,
    CONTAINER, PARITY_CONTAINER, PAD_CONTAINER,
    DATA_OBJECT
